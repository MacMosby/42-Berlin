...
/*   Updated: 2023/02/26 23:35:51 by mrodenbu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int *ft_num_divider(unsigned int num, int *arr, int power, int index);
...
int main(int argc, char **argv)
{
	...
	ft_num_divider(nbr, array, 9, 0); // splitting the number into an array of printable strings
